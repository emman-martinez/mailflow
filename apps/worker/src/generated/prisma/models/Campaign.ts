...
export type CampaignOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "name" | "subject" | "body" | "status" | "scheduledAt" | "timezone" | "createdAt" | "updatedAt" | "ownerId", ExtArgs["result"]["campaign"]>
...
export interface Prisma__CampaignClient<T, Null = never, ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
  ...
  jobs<T extends Prisma.Campaign$jobsArgs<ExtArgs> = {}>(args?: Prisma.Subset<T, Prisma.Campaign$jobsArgs<ExtArgs>>): Prisma.PrismaPromise<runtime.Types.Result.GetResult<Prisma.$EmailJobPayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
  /**
